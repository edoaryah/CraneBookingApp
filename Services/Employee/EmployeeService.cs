...
namespace AspnetCoreMvcFull.Services
{
  public class EmployeeService : IEmployeeService
  {
    ...
    public async Task<Employee?> GetManagerByDepartmentAsync(string department)
    {
      try
      {
        using (var connection = new SqlConnection(_connectionString))
    ...
    public async Task<IEnumerable<Employee>> GetPicCraneAsync()
    {
      var picEmployees = new List<Employee>();
