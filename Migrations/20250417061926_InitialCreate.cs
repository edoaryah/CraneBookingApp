    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cranes",
                columns: new[] { "Id", "Capacity", "Code", "ImagePath", "Status" },
                values: new object[,]
                {
                    { 1, 250, "LC008", null, "Available" },
                    { 2, 150, "LC009", null, "Available" },
                    { 3, 100, "LC010", null, "Available" },
                    { 4, 150, "LC011", null, "Available" },
                    { 5, 35, "LC012", null, "Available" },
                    { 6, 15, "LC013", null, "Available" }
                });
